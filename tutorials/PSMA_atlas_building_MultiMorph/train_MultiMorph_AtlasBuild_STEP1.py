...
from MIR.models import GroupNet3D, SpatialTransformer, Warp3d
...
def main():
    ...
    save_dir = 'VFAAtlas_AutoPET_SSIM_{}_MS_{}_diffusion_{}/'.format(weights[0], weights[1], weights[2])
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            ...
            loss_suv_1 = criterion_img(template[0:1], x[0, :, 0:1]) * weights[0] / 2
            loss_img_1 = criterion_img(template[1:2], x[0, :, 1:2]) * weights[0] / 2
