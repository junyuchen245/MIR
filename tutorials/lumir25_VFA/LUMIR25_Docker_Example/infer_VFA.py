...
def main():
    ...
    json_dir = "/app/LUMIR25_dataset.json"
    ...
    pretrained_multi = torch.load(wts_dir+pretrained_wts_multi)[ModelWeights['VFA-LUMIR25-MultiModal']['wts_key']]
    pretrained_mono = torch.load(wts_dir+pretrained_wts_mono)[ModelWeights['VFA-LUMIR24-MonoModal']['wts_key']]
    model.cuda()
    
    '''
    Initialize training
    '''
    val_set = L2RLUMIRJSONDataset(base_dir=input_dir, json_path=json_dir, stage='validation')
