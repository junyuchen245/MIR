...
def convex_adam_MIND_SPR(
    ...
    displacements, spr_wts = convex_adam_pt(
        ...
        logBeta_weight=configs.logBeta_weight,
...
if __name__=="__main__":
    ...
    convex_adam(
        ...
        logBeta_weight=args.logBeta_weight,
