...
from MIR.models.convexAdam.convex_adam_utils import (correlate, coupled_convex,
                                          inverse_consistency)
...
def convex_adam_seg_features(feat_moving, feat_fixed, configs):
    displacements = convex_adam(feat_fixed[0,0],
                feat_moving[0,0],
