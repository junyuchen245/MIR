...
from MIR.models.fireants.io.image import BatchedImages
...
from MIR.models.fireants.registration.distributed.utils import gather_and_concat, refactor_grid_to_image_stats, calculate_bbox_from_gather_stats, async_send_tensor_ack, async_recv_tensor_ack
